...
apt-get -y install tmux python-setuptools mysql-server python-dev python-pip git pv python-mysqldb python-lxml vim-nox make libpcre3-dev iptables-persistent
